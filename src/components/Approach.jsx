        ...
        <div className="w-full py-16 px-4 text-white font-Poppins h-[150vh]">
            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                ...
                <div className="flex justify-center flex-col">
                    ...
                    <p className="my-1 text-sm text-offwhite md:text-left text-center"> Wherever a student may struggle, our tutors will help improve their weaknesses and make their strengths shine even brighter. Whether that's focusing on thesis statements, grammar, voice, commentary, or any other area, we remain confident that we can bring out their full potential.</p>
                </div>
            </div>
        </div>
    )
