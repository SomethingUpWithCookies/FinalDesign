...
const newsCard = (props) => {
    return(
        <div className="group font-Poppins w-[450px] sm:w-[500px] md:w-[500px]  text-black grid grid-cols-2 gap-2 bg-white rounded-2xl">
            ...
            <div className="flex justify-center flex-col">
                ...
                <p className="mt-auto text-right pr-4 text-offwhite">{props.date}</p>
